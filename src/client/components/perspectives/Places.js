    ...
    <React.Fragment>
      ...
      <Route
        ...
        render={() =>
          <GMap
            results={props.results}
            googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyDGnx-oaFWaUPDElYDwNWVUeA8G4uLCKo0&v=3.exp&libraries=geometry,drawing,places,visualization"
