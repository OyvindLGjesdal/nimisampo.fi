    ...
    <React.Fragment>
      ...
      <Route
        ...
        render={() =>
          <GMap
            results={props.results}
            googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyAwkjooQWS_hdtOHakBmruAhTYPU-rSWvY&v=3.exp&libraries=geometry,drawing,places,visualization"
