    ...
    <React.Fragment>
      ...
      <Route
        ...
        render={() =>
          <GMap
            results={props.results}
            googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyDkbOKIqr29qe68rPqN1SwFACYfeNyz0wQ&v=3.exp&libraries=geometry,drawing,places,visualization"
